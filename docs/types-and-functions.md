...
| `RootView` | the app's root: owns the model and the tutorial model, opens on login or on the table with the welcome card (`initialScreen(for:)`), crossfades between login, intro and table | `rootOpensOnLoginUntilSignedInThenOnTheTable` |
