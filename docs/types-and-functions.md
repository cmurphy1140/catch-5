...
| `WoodGrainView`, `GrainRandom` | `WoodGrainView.swift`: the oak table top drawn in a `Canvas`, grain running across the screen from a fixed seed (gradient, bands, grain lines, vignette); no image asset | manual |
