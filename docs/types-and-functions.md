...
| `WoodGrainView`, `GrainRandom` | `WoodGrainView.swift`: the walnut table top drawn in a `Canvas` from a fixed seed (gradient, bands, grain lines, vignette); no image asset | manual |
