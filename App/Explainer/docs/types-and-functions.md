...
| `WelcomeCard` | the returning player's card over the dimmed table: portrait and name, Continue game (until the match is won), New match (confirms only if it would throw away bids or plays), Settings, How Catch 5 is built; reopened by the table's chevron | manual |
