...
| **View** | Draw the current state. Send user intent to the view model. | `RootView`, `LoginView`, `IntroView`, `WelcomeCard`, `TableView`, `CardView`, `HandSummaryView` | Hold game state, mutate the model directly, or decide legality |
